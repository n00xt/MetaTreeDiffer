...
public class Java8BaseListener implements Java8Listener {
	...
	private int i = 0;
	private int j = 0;
	private StringBuilder rted = new StringBuilder();
	private StringBuilder ast = new StringBuilder();
	private StringBuilder tokens = new StringBuilder();
	private StringBuilder famix = new StringBuilder();
	private StringBuilder famixRted = new StringBuilder();

	public String getFamixRted() {
		return famixRted.toString();
	}

	public String getFamix() {
        return famix.toString();
    }

    public String getRted() {
		return rted.toString();
	}
	...
	private void setEnterMode (RuleContext ctxSimpleName){
		ast.append("{"+ctxSimpleName.getClass().getSimpleName().replace("Context", ""));
		tokens.append("{"+ctxSimpleName.invokingState);
		rted.append("{"+ i++);
	}
	 ...
	 * <p>The default implementation does nothing.</p>
	 */
	@Override public void enterElseStatementnoShortIf(Java8Parser.ElseStatementnoShortIfContext ctx) {
		setEnterMode(ctx);
	}
	/**
	 * {@inheritDoc}
	 ...
	 * <p>The default implementation does nothing.</p>
	 */
	@Override public void exitElseStatementnoShortIf(Java8Parser.ElseStatementnoShortIfContext ctx) {
	}
	/**
	 * {@inheritDoc}
	 *
